...
export interface Stage {
  ...
  /** 成绩计划锁定时间；未设则默认 = Stage 结束 + Competition.resultLockWindowHours（默认 24h）。 */
        ...
        stages: [
          {
            ...
            sessions: [
              ...
              { id: 'c3r1s1se3', stageId: 'c3r1s1', type: 'race', name_zh: '正赛', name_en: 'Race', startsAt: '2026-06-29T11:45:00Z', endsAt: '2026-06-29T12:15:00Z', raceDuration: 30, raceDurationType: 'time', resultType: 'classification', splits: [{ id: 'c3r1s1se3sp1', sessionId: 'c3r1s1se3', splitNumber: 1, serverName: 'CN GT4 Shanghai #1', serverPassword: 'shanghaigt42026', adminPassword: 'admin123', maxConnections: 24, registerToLobby: true, resultsLockedAt: '2026-06-29T13:30:00Z', entryList: [
                  ...
                  { position: 1, driverId: 'd11', teamId: 't1', splitNumber: 1, totalTime: '29:42.118', bestLap: '2:08.342', lapsCompleted: 14, gapToLeader: '-', status: 'Finished', points: 20 },
                  { position: 2, driverId: 'd1', teamId: 't1', splitNumber: 1, totalTime: '29:45.605', bestLap: '2:08.689', lapsCompleted: 14, gapToLeader: '+3.487', status: 'Finished', points: 15 },
                  { position: 3, driverId: 'd5', splitNumber: 1, totalTime: '29:51.234', bestLap: '2:09.115', lapsCompleted: 14, gapToLeader: '+9.116', status: 'Finished', points: 12 },
                  { position: 4, driverId: 'd15', teamId: 't2', splitNumber: 1, totalTime: '29:58.877', bestLap: '2:09.502', lapsCompleted: 14, gapToLeader: '+16.759', status: 'Finished', points: 10 },
                  { position: 5, driverId: 'd9', splitNumber: 1, totalTime: '30:05.441', bestLap: '2:09.884', lapsCompleted: 14, gapToLeader: '+23.323', status: 'Finished', points: 8 },
                ] }] },
            ],
          },
        ],
...
export function defaultSplitConfig(): Partial<Split> {
  const { id: _id, splitNumber: _sn, entryList: _el, results: _r, resultsLockedAt: _rp, ...rest } = createDefaultSplit('tpl', 1)
