        ...
        <div className="max-w-5xl mx-auto p-6 space-y-6">
          ...
          <Card>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <Input label={t('event.resultLockWindow')} type="number" min={0} value={String(comp.resultLockWindowHours ?? 24)} onChange={(e) => setLocal(prev => ({ ...prev, resultLockWindowHours: e.target.value ? Number(e.target.value) : undefined }))} />
